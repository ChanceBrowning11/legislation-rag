...
def main() -> None:
  """
  Run the baseline RAG pipeline for a user question.
  """
  parser = argparse.ArgumentParser(
    description="Run the baseline RAG pipeline using original bill chunks only."
  )
  parser.add_argument(
    "--question",
    type=str,
    required=True,
    help="Question to ask the baseline RAG system.",
  )
  parser.add_argument(
    "--k",
    type=int,
